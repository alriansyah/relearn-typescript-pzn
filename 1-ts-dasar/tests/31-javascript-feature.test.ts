/*
    ...
    - Ketika menggunakan typescript, diusahaakan sebisa mungkin hindari penggunaan tipe data any
    - Jika memang ada data yang spesifik, sebaiknya kita bikin interface atau type alias untuk tipe data tersebut
*/
